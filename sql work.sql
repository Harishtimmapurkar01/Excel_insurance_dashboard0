...
select account_Executive,count(*)as no_invoice from invoice group by 1; 
...
(select invoice_cross from invoice limit 1)as Invoice,
...
(select invoice_renewal from invoice limit 1) as Invoice,
...
(select invoice_new from invoice limit 1) as Invoice,
